...
contract("Allocations", function (accounts) {
    describe("Supply", function () {
        const [owner, wallet, liquidity, team, marketing, presale, reserve, technology, legal, advisor, ido] = accounts;
        ...
        beforeEach(async function () {
            ...
            await this.token.transfer(this.allocations.address, allocationsSupply, {from: from});
        });

        it("has a total supply - 160 775 000 ", async function () {
            expect(await this.token.balanceOf(this.allocations.address)).to.be.bignumber.equal(
                allocationsSupply
            );
        });
    ...
    describe("Change Wallet Process", function () {
        ...
        it("owner can update liquidity wallet", async function () {
            ...
            expect(await this.allocations.liquidity()).to.be.equal(
                liquidity
            );
        });
        ...
        it("owner can update marketing wallet", async function () {
            ...
            expect(await this.allocations.marketing()).to.be.equal(
                marketing
            );
        });
        ...
        it("owner can update presale wallet", async function () {
            ...
            expect(await this.allocations.presale()).to.be.equal(
                presale
            );
        });
        ...
        it("owner can update reserve wallet", async function () {
            ...
            expect(await this.allocations.reserve()).to.be.equal(
                reserve
            );
        });
        ...
        it("owner can update technology wallet", async function () {
            ...
            expect(await this.allocations.technology()).to.be.equal(
                technology
            );
        });
        ...
        it("owner can update legal wallet", async function () {
            ...
            expect(await this.allocations.legal()).to.be.equal(
                legal
            );
        });
        ...
        it("owner can update advisor wallet", async function () {
            ...
            expect(await this.allocations.advisor()).to.be.equal(
                advisor
            );
        });
        ...
        it("owner can update ido wallet", async function () {
            ...
            expect(await this.allocations.ido()).to.be.equal(
                ido
            );
        });
    });
